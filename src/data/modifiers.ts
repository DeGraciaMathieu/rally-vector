...
// - Boost : +50 % d'autorité de poussée, grip ×0.72 (contrôle dégradé), 3 charges/run.
//   net portée ×1.08 + accélération plus vive ; arbitrage vitesse vs contrôle. (Le
//   plafond mord à pleine vitesse : le boost ne perce pas la pointe, il pousse plus fort.)
...
export const MODIFIERS: readonly Modifier[] = [
  ...
  { id: 'boost', label: 'Boost', mods: { impulse: 1.5, grip: 0.72, drag: 1, vel: 1 }, charges: 3 },
